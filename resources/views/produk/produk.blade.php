                        ...
                        if(Array.isArray(data)) {
                            data.forEach(url => {
                                if(url){
                                    ...
                                    html += `<img src="http://139.168.116.18:8813/storage/${url}" class="w-10 h-10 object-cover rounded shadow mr-1 mb-1 inline-block cursor-pointer hover:scale-105 transition-transform" onclick="showImageModal('http://139.168.116.18:8813/storage/${url}')">`;
                                }
                            });
                            return html || '-';
                        }
