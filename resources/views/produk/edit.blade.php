    ...
    <form method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6" id="form">
        ...
        <div class="space-y-4 p-4 bg-white rounded-lg border border-blue-100">
            ...
            <div class="flex items-center space-x-4">
                <img src="https://api.allorigins.win/raw?url=http://139.255.116.18:8813/storage/{{ urlencode($foto) }}"
                    alt="Gambar {{ $index + 1 }}"> class="w-24 h-24 object-cover border rounded-lg"
                onerror="this.onerror=null; this.src='{{ asset('public/images/no-image.png') }}'; console.log('Image
                failed:', '{{ $foto }}')">
