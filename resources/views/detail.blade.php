                ...
                <div class="bg-gray-50 rounded-xl p-6">
                            ...
                            <div id="carousel-track" class="flex transition-transform duration-500 ease-in-out h-full">
                                ...
                                <div class="w-full flex-shrink-0 relative">
                                    <img @if(str_contains(config('app.backend_storage_url'), '127.0.0.1' ))
                                        src="{{ config('app.backend_storage_url') }}/storage/{{ $imageUrl }}"
                                        onclick="openModal('{{ config('app.backend_storage_url') }}/storage/{{ $imageUrl }}')"
                                        @else
                                        src="https://images.weserv.nl/?url={{ config('app.backend_storage_url') }}/storage/{{ $imageUrl }}"
                                        onclick="openModal('https://images.weserv.nl/?url={{ config('app.backend_storage_url') }}/storage/{{ $imageUrl }}')"
                                        @endif alt="{{ $produk['NamaStock'] }}"
                    ...
                    <div class="flex gap-3 mt-4 justify-center overflow-x-auto pb-2">
                        ...
                        <button
                            ...
                            <img @if(str_contains(config('app.backend_storage_url'), '127.0.0.1' ))
                                src="{{ config('app.backend_storage_url') }}/storage/{{ $thumbUrl }}" @else
                                src="https://images.weserv.nl/?url={{ config('app.backend_storage_url') }}/storage/{{ $thumbUrl }}"
                                @endif alt="Thumbnail {{ $index + 1 }}" class="w-full h-full object-cover"
                                onerror="this.onerror=null; this.src='{{ asset('public/images/no-image.png') }}';">
                        </button>
                        @endforeach
                    </div>
            ...
            <div class="w-full lg:w-1/2">
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div
                            class="bg-gradient-to-b from-blue-50 to-blue-100 rounded-xl p-5 text-center border border-blue-300 shadow-sm hover:shadow-lg transition duration-200">
                            <label class="text-xs font-semibold text-blue-700 uppercase tracking-wider block">{{ $label
                                }}</label>
                        ...
                        <!-- Harga Yuan -->
                        <div
                            class="bg-gradient-to-b from-yellow-50 to-yellow-100 rounded-xl p-5 text-center border border-yellow-300 shadow-sm hover:shadow-lg transition duration-200">
                            <label class="text-xs font-semibold text-yellow-700 uppercase tracking-wider block">Harga
                                Yuan</label>
                            <p class="text-2xl font-extrabold text-yellow-900 mt-2">
                        ...
                        <!-- Harga Beli -->
                        <div
                            class="bg-gradient-to-b from-red-50 to-red-100 rounded-xl p-5 text-center border border-red-300 shadow-sm hover:shadow-lg transition duration-200">
                            <label class="text-xs font-semibold text-red-700 uppercase tracking-wider block">Harga
                                Beli</label>
                            <p class="text-2xl font-extrabold text-red-900 mt-2">
